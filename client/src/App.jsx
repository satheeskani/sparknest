    ...
    <>
      <style>{`
        ...
        .lang-fab {
          ...
          animation: lang-gradient 3s linear infinite, lang-glow 2.5s ease-in-out infinite;
          border:none; cursor:pointer; font-size:1.35rem; line-height:1;
          transition:transform .2s;
        }
        ...
        .lang-menu {
          ...
          border-radius:16px; padding:0.45rem; min-width:148px;
          box-shadow:0 -8px 32px rgba(0,0,0,0.5), 0 0 20px rgba(255,107,0,0.15);
          animation:lang-pop .2s cubic-bezier(.22,1,.36,1);
          z-index:1000;
        }
        .lang-option {
          display:flex; align-items:center; gap:0.65rem; width:100%;
          border:none; border-radius:10px; padding:0.55rem 0.85rem;
          font-family:'Nunito Sans',sans-serif; font-weight:800; font-size:0.88rem;
      ...
      <div ref={ref} style={{ position:"fixed", bottom:"5.5rem", right:"1.5rem", zIndex:999 }}>
        {open && (
          <div className="lang-menu">
            <p style={{ margin:"0 0 0.35rem", padding:"0 0.5rem", fontSize:"0.6rem", fontWeight:800, letterSpacing:"0.14em", textTransform:"uppercase", color:"rgba(255,215,0,0.45)", fontFamily:"'Nunito Sans',sans-serif" }}>
              Language
            </p>
            {LANGS.map(l => (
              <button key={l.code}
                ...
                style={{
                  background: lang === l.code ? "linear-gradient(135deg,rgba(255,107,0,0.22),rgba(255,61,0,0.12))" : "transparent",
                  border: lang === l.code ? "1px solid rgba(255,107,0,0.35)" : "1px solid transparent",
                  color: lang === l.code ? "#FFD700" : "#FFF5E6",
                }}>
        ...
        <button className="lang-fab" onClick={() => setOpen(o => !o)}>
          🌐
        </button>
      </div>
    </>
