        ...
        <div>
          ...
          {step === 2 && (
            <div id="order-section" style={{ display: "flex", flexDirection: "column", gap: "1.1rem" }}>
              ...
              {/* Confirm Order CTA */}
              <button onClick={handleConfirmOrder} style={{ width: "100%", padding: "1rem", background: "linear-gradient(135deg,#FF6B00,#FF3D00)", border: "none", borderRadius: 14, color: "#fff", fontWeight: 800, fontSize: "1.05rem", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "0.5rem", boxShadow: "0 4px 20px rgba(255,107,0,0.5)", fontFamily: "'Source Sans 3',sans-serif" }}>
                ✅ Confirm Order
              </button>
