  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0D0600", fontFamily: "'Source Sans 3',sans-serif", paddingTop: 88 }}>
      <style>{`
        ...
        /* ── Labels ── */
        .co-label {
          font-size:1rem; color:rgba(255,245,230,0.6);
      ...
      <div className="co-layout" style={{ maxWidth: 980, margin: "0 auto", padding: "1.5rem 1rem 3rem", display: "grid", gridTemplateColumns: "1fr 310px", gap: "1.5rem", alignItems: "start" }}>
        ...
        <div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "1.6rem" }}>
            {["Delivery Address", "Payment & Summary"].map((s, i) => (
              <div key={i} style={{ display: "flex", alignItems: "center", gap: "0.4rem" }}>
                ...
                <span className="co-step-label" style={{ fontSize: "1.05rem", fontWeight: step === i + 1 ? 700 : 500, color: step === i + 1 ? "#FFF5E6" : "rgba(255,245,230,0.65)" }}>{s}</span>
          ...
          {/* ── STEP 1: ADDRESS ── */}
          {step === 1 && (
            <div className="co-card" style={{ background: "rgba(255,107,0,0.03)", border: "1px solid rgba(255,107,0,0.1)", borderRadius: 18, padding: "1.6rem" }}>
          ...
          {step === 2 && (
            <div id="order-section" style={{ display: "flex", flexDirection: "column", gap: "1.1rem" }}>
              ...
              {/* Order items */}
              <div className="co-card" style={{ background: "rgba(255,107,0,0.03)", border: "1px solid rgba(255,107,0,0.1)", borderRadius: 14, padding: "1.2rem" }}>
                <h3 className="co-section-title" style={{ color: "#FFF5E6", fontSize: "1.05rem", fontWeight: 800, margin: "0 0 0.9rem" }}>🛒 Your Order ({items.reduce((s, i) => s + i.quantity, 0)} items)</h3>
                  ...
                  {items.map(item => (
                    <div key={item._id} style={{ display: "flex", alignItems: "center", gap: "0.7rem" }}>
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <p className="co-item-name" style={{ color: "#FFF5E6", fontSize: "1.05rem", fontWeight: 700, margin: 0, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{item.name}</p>
                        <p className="co-item-sub" style={{ color: "rgba(255,245,230,0.7)", fontSize: "0.9rem", margin: "0.15rem 0 0" }}>Qty: {item.quantity} × ₹{item.price.toLocaleString()}</p>
                      </div>
              ...
              {/* Payment section */}
              <div className="co-card" style={{ background: "rgba(255,107,0,0.03)", border: "1px solid rgba(255,107,0,0.1)", borderRadius: 14, padding: "1.2rem" }}>
                <h3 className="co-section-title" style={{ color: "#FFF5E6", fontSize: "1.05rem", fontWeight: 800, margin: "0 0 1rem" }}>💳 Pay Here</h3>
                ...
                <div style={{ background: "rgba(37,211,102,0.06)", border: "1px solid rgba(37,211,102,0.2)", borderRadius: 12, padding: "0.9rem 1rem", marginBottom: "1rem" }}>
                  ...
                  <p className="co-upi-hint" style={{ color: "rgba(255,245,230,0.65)", fontSize: "1.05rem", margin: "0.5rem 0 0" }}>Pay via GPay · PhonePe · Paytm · Any UPI app</p>
                </div>
                        ...
                        {[
                          ...
                          <div key={label} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: "0.5rem" }}>
                            <div style={{ minWidth: 0 }}>
                              <p className="co-bank-label" style={{ color: "rgba(255,245,230,0.65)", fontSize: "1rem", fontWeight: 700, margin: 0, textTransform: "uppercase", letterSpacing: "0.04em" }}>{label}</p>
                              <p className="co-bank-value" style={{ color: "#FFF5E6", fontWeight: 700, fontSize: "0.9rem", margin: "0.1rem 0 0", wordBreak: "break-all" }}>{value}</p>
                            </div>
                            <CopyBtn text={value} />
                          </div>
                        ))}
              ...
              {!whatsappSent ? (
                ...
                <div style={{ background: "rgba(37,211,102,0.07)", border: "1px solid rgba(37,211,102,0.22)", borderRadius: 14, padding: "1.1rem", textAlign: "center" }}>
                  ...
                  <p style={{ color: "rgba(255,245,230,0.7)", fontSize: "1.05rem", margin: 0 }}>WhatsApp opened on your device</p>
                </div>
              )}
